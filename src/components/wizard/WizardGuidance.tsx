...
import { ChatBubbleLeftRightIcon, InformationCircleIcon, LightBulbIcon } from '@heroicons/react/24/outline';
    ...
    <div className="space-y-4">
      ...
      {guidance.suggested_question && (
        <Card className="bg-yellow-50 border-yellow-200">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              <ChatBubbleLeftRightIcon className="h-5 w-5 text-yellow-600 flex-shrink-0 mt-0.5" />
              <div className="flex-1">
